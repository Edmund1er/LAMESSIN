...
class Medicament(models.Model):
    nom_commercial = models.CharField(max_length=100, db_index=True) # db_index pour accélérer la recherche
...
# ====================================================================================================================
# MODULE : RENDEZ-VOUS & CONSULTATIONS (LES SOINS)
# ====================================================================================================================
...
class RendezVous(models.Model):
    ...
    def __str__(self):
        return f"RDV: {self.patient_demandeur.compte_utilisateur.last_name} - {self.date_rdv}"

class Consultation(models.Model):
    """ Pour enregistrer les soins effectués (caries, etc.) """
    rdv = models.OneToOneField(RendezVous, on_delete=models.CASCADE, related_name="consultation")
    diagnostic = models.TextField() # Ex: "Carie sur la 36"
    actes_effectues = models.TextField() # Ex: "Plombage, détartrage"
    notes_medecin = models.TextField(blank=True, null=True)
    date_consultation = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"Soin de {self.rdv.patient_demandeur} le {self.date_consultation.date()}"

# ====================================================================================================================
# MODULE : ORDONNANCES & TRAITEMENTS
# ====================================================================================================================
...
# ====================================================================================================================
# MODULE : COMMANDES, CHAT & NOTIFICATIONS
# ====================================================================================================================
